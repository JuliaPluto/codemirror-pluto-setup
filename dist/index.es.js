    ...
    parser: parser.configure({
        props: [
            ...
            indentNodeProp.add({
                ...
                ModuleDefinition: noIndent,
                BareModuleDefinition: noIndent,
                VariableDeclaration: continuedIndent(),
                AssignmentExpression: continuedIndent(),
            }),
        ],
...
const keywordCompletion = language.data.of({
    autocomplete: completeFromList(syntaxConfig.keywords.map((keyword) => ({
        label: keyword.name,
        type: "keyword",
    }))),
});
